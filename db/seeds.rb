...
card_data = [
  ["Sessions","Jeff","money","Notable Campaign Donors","Mr. Sessions received $10,000 donations from Exxon Mobil in 2014 and 2016 and subsequently wrote a letter to the Department of Justice (which he now heads) requesting that it cease its investigation into whether Exxon Mobil knew and hid information related to its products' effects on climate change.","https://www.documentcloud.org/documents/3222852-Sessions-Letter-to-Lynch.html"],
	...
	["Sessions","Jeff","handshake","Personal Connections","Mr. Sessions received $10,000 donations from ExxonMobil in 2014 "],
	["Price","Tom","handshake","Personal Connections"],
	["Perry","Rick","handshake","Personal Connections"],
	["Zinke","Ryan","handshake","Personal Connections"],
	["Tillerson","Rex","handshake","Lobbying"],
	["Perdue","Sonny","handshake","Personal Connections","Mr. Perdue's cousin, David Perdue, is a U.S. Senator who reportedly urged President Trump to select his cousin for the last remaining cabinet position. ","https://www.bloomberg.com/politics/articles/2017-01-19/trump-said-to-nominate-sonny-perdue-as-agriculture-secretary"],
	["Mnuchin","Steve","handshake","Lobbying"],
	["Ross","Wilbur","handshake","Lobbying"],
	["Acosta","Alexander","handshake","Lobbying"],
	["Mattis","James","handshake","Boards"],
	["Kelly","John","handshake","Boards"],
	["Shulkin","David","handshake","Boards"],
	["Chao","Elaine","handshake","Personal Relationships","Ms. Chao is married to Senate Majority Leader Mitch McConnell of Kentucky. Mr. McConnell is the chief spokesperson for the Republican majority led senate. "],
	["DeVos","Betsy","handshake","Personal Relationships","Ms. DeVos is the daughter-in-law of the cofounder of Amway, billionaire Richard DeVos, who has been an active member and donor to the Republican party.","http://www.frc.org/mission-statement"],
	["Carson","Benjamin","handshake","Personal Relationships"],
	["Sessions","Jeff","gift","Gifts and Trips"],
	["Price","Tom","gift","Gifts and Trips"],
	["Perry","Rick","gift","Gifts and Trips"],
	["Zinke","Ryan","gift","Gifts and Trips"],
	["Tillerson","Rex","gift","Pending Rules/Regulations"],
	["Perdue","Sonny","gift","Gifts and Trips"],
	["Mnuchin","Steve","gift","Pending Rules/Regulations"],
	["Ross","Wilbur","gift","Pending Rules/Regulations"],
	["Acosta","Alexander","gift","Pending Rules/Regulations"],
	["Mattis","James","gift","Financial Disclosure"],
	["Kelly","John","gift","Financial Disclosure"],
	["Shulkin","David","gift","Financial Disclosure"],
	["Chao","Elaine","gift","Business Interests"],
	["DeVos","Betsy","gift","Business Interests"],
	["Carson","Benjamin","gift","Business Interests"],
	["Sessions","Jeff","about","About"],
